...
namespace DnD_Character_Creator.Backgrounds
{
    ...
    {
        public static string[] PersonalityTrait { get; protected set; } = new string[8];
        public static string[] Ideal { get; protected set; } = new string[6];
        public static string[] Bond { get; protected set; } = new string[6];
        public static string[] Flaw { get; protected set; } = new string[6];
        ...
        public static GHBackground Seafarer(Character character)
        {
            ...
            int choice = CLIHelper.GetChoiceFromPair("Pick from a list of examples.", "Leave it as 'Lucky charm'.");
