...
namespace DnD_Character_Creator.Backgrounds
{
    public class Background
    {
        ...
        public static Dictionary<string, Background> AllBackgrounds { get; set; } = new Dictionary<string, Background>
        {
            { "acolyte", Acolyte() },
            { "charltan", Charltan() },
            { "criminal", Criminal() },
        ...
        public static Background Acolyte()
        {
            ...
            result.Ideal[4] = "Faith. I trust that my deity will guide my actions, I have faith that if I work hard, things will go well. (Lawful)";
            result.Ideal[5] = "Aspiration. I seek to prove myself worthy of my god’s favor by matching my actions against his or her teachings. (Any)";
        ...
        public static Background Charltan()
        {
            ...
            result.Bond[0] = "I fleeced the wrong person and must work to ensure that this individual never crosses paths with me or those I care about.";
            ...
            result.Bond[5] = "I swindled and ruined a person who didn’t deserve it.I seek to atone for my misdeeds but might never be able to forgive myself.";
            ...
            result.Flaw[5] = "I hate to admit it and will hate myself for it, but I'll run and preserve my own hide if the going gets tough.";
        ...
        public static Background Criminal()
        {
            ...
            result.PersonalityTrait[2] = "The first thing I do in a new place is note the location of everything valuable - or where such things could be hidden.";
            ...
            result.Ideal[4] = "People. I’m loyal to my friends, not to any ideals, and everyone else can take a trip down the Styx for all I care. (Neutral)";
        ...
        public static Background Entertainer()
        {
            ...
            result.Feature = "By Popular Demand: you can always find a place to perform, usually an inn or a tavern, but it could be a circus," +
                ...
                "\nlevel of food (as long as you perform each night). Your performances also make you a local figure - strangers" +
                "\nrecognize you and usually like you.";
            ...
            result.Ideal[1] = "Tradition. The stories, legends, and songs of the past must never be forgotten, for they teach us who we are. (Lawful)";
        ...
        public static Background GuildArtisan()
        {
            ...
            result.PersonalityTrait[7] = "I’m well known for my work, and I want to make sure everyone appreciates it. I'm always taken aback when people haven’t heard of me.";
            result.Ideal[0] = "Community. It is the duty of all civilized people to strengthen the bonds of community and the security of civilization. (Lawful)";
            ...
            result.Bond[1] = "I created a great work for someone, and then found them unworthy to receive it. I’m still looking for someone worthy.";
        ...
        public static Background Noble()
        {
            ...
            result.Ideal[0] = "Respect. Respect is due to me because of my position, but all people regardless of station deserve to be treated with dignity. (Good)";
            result.Ideal[1] = "Responsibility. It is my duty to respect the authority of those above me, just as those below me must respect mine. (Lawful)";
        ...
        public static Background Outlander()
        {
            ...
            result.PersonalityTrait[2] = "I once ran twenty-five miles without stopping to warn to my clan of an approaching orc horde.I’d do it again if I had to.";
            ...
            result.Flaw[5] = "Don’t expect me to save those who can’t save themselves. It is nature’s way that the strong thrive and the weak perish.";
        ...
        public static Background Sage()
        {
            ...
            result.Languages.Add("Choice");
            result.Languages.Add("Choice2");
            result.Equipment.Add("Bottle of black ink");
            result.Equipment.Add("Quill");
            ...
            result.PersonalityTrait[2] = "I'm used to helping out those who aren’t as smart as I am, and I patiently explain anything and everything to others.";
        ...
        public static Background Sailor()
        {
            ...
            result.Bond[5] = "Ruthless pirates murdered my captain and crewmates, plundered our ship, and left me to die.Vengeance will be mine.";
        ...
        public static Background Soldier()
        {
            ...
            result.PersonalityTrait[3] = "I’m full of inspiring and cautionary tales from my military experience relevant to almost every combat situation.";
        ...
        public static Background Urchin()
        {
            ...
            result.Ideal[2] = "Change. The low are lifted up, and the high and mighty are brought down. Change is the nature of things. (Chaotic)";
