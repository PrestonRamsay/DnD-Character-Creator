    ...
    public static class WizardSpecifics
    {
        ...
        public static CharacterClass Features(Character character, CharacterClass result)
        {
            ...
            if (lvl >= 2)
            {
                ...
                {
                    case "Abjuration":
                        Abjuration(character, result);
                        break;
                    case "Bladesinging":
                        Bladesinging(character, result);
                        break;
                    case "Chronurgy Magic":
                        ChronurgyMagic(character, result);
                        break;
                    case "Conjuration":
                        Conjuration(character, result);
                        break;
                    case "Divination":
                        Divination(character, result);
                        break;
                    case "Enchantment":
                        Enchantment(character, result);
                        break;
                    case "Evocation":
                        Evocation(character, result);
                        break;
                    case "Graviturgy Magic":
                        GraviturgyMagic(character, result);
                        break;
                    case "Illusion":
                        Illusion(character, result);
                        break;
                    case "Necromancy":
                        Necromancy(character, result);
                        break;
                    case "Order of Scribes":
                        OrderOfScribes(character, result);
                        break;
                    case "Transmutation":
                        Transmutation(character, result);
                        break;
                    case "War Magic":
                        WarMagic(character, result);
                        break;
                }
            }
        ...
        public static void Abjuration(Character character, CharacterClass result)
        {
        ...
        public static void Bladesinging(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void ChronurgyMagic(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Conjuration(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Divination(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            ...
            if (lvl >= 6)
            {
                result.ClassFeatures.Add("Expert Divination", "when you cast a lvl 2 or higher Divination spell, regain a spell slot <= spell lvl(max 5)");
            }
            if (lvl >= 10)
            {
        ...
        public static void Enchantment(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Evocation(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void GraviturgyMagic(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            string size = "Large";
            if (lvl >= 10)
        ...
        public static void Illusion(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Necromancy(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void OrderOfScribes(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Transmutation(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void WarMagic(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
