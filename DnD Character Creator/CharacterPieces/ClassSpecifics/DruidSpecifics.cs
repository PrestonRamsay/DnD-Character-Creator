    ...
    public static class DruidSpecifics
    {
        ...
        public static CharacterClass Features(CharacterClass result, Character character)
        {
            ...
            if (lvl >= 2)
            {
                ...
                {
                    case "Dreams":
                        Dreams(character, result);
                        break;
                    case "Land":
                        Land(character, result);
                        break;
                    case "Moon":
                        Moon(character, result);
                        break;
                    case "Shepherd":
                        Shepherd(character, result);
                        break;
                    case "Spores":
                        Spores(character, result);
                        break;
                    case "Stars":
                        Stars(character, result);
                        break;
                    case "Wildfire":
                        Wildfire(character, result);
                        break;
                }
            }
            int num = 2;
        ...
        public static void Dreams(Character character, CharacterClass result)
        {
        ...
        public static void Land(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Moon(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Shepherd(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Spores(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Stars(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Wildfire(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            ...
            result.ClassFeatures.Add("Summon Wildfire Spirit", "action, 1 hr, 30ft, expend Wild Shape use, summon wildfire spirit, 10ft, Dex save, 2D6 Fire dmg, bonus to command, TCE pg 40");
            if (lvl >= 6)
            {
