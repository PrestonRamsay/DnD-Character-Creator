    ...
    public static class PaladinSpecifics
    {
        ...
        public static CharacterClass Features(Character character, CharacterClass result)
        {
            ...
            if (lvl >= 3)
            {
                ...
                {
                    case "Ancients":
                        Ancients(character, result);
                        break;
                    case "Conquest":
                        Conquest(character, result);
                        break;
                    case "Crown":
                        Crown(character, result);
                        break;
                    case "Devotion":
                        Devotion(character, result);
                        break;
                    case "Glory":
                        Glory(character, result);
                        break;
                    case "Oathbreaker":
                        Oathbreaker(character, result);
                        break;
                    case "Redemption":
                        Redemption(character, result);
                        break;
                    case "Vengeance":
                        Vengeance(character, result);
                        break;
                    case "Watchers":
                        Watchers(character, result);
                        break;
                }
            }
            if (lvl >= 4)
            ...
            if (lvl >= 18)
            {
                ...
                switch (SacredOath)
                {
                    case "Ancients":
                        ...
                        break;
                    case "Devotion":
                        result.ClassFeatures["Aura of Devotion"] = "30ft, gain Immunity to charm";
                        break;
                    case "Glory":
        ...
        public static void Archetype(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        }
        public static void Ancients(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Conquest(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Crown(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Devotion(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            ...
            if (lvl >= 7)
            {
                result.ClassFeatures.Add("Aura of Devotion", "10ft, gain Immunity to charm");
            }
            if (lvl >= 15)
            {
        ...
        public static void Glory(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Oathbreaker(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Redemption(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Vengeance(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Watchers(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
