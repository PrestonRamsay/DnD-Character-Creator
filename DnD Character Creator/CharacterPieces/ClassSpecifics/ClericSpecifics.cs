...
namespace DnD_Character_Creator.CharacterPieces.ClassSpecifics
{
    public static class ClericSpecifics
    {
        ...
        public static CharacterClass Features(CharacterClass result, Character character)
        {
            ...
            {
                case "Ambition":
                    Ambition(character, result);
                    break;
                case "Arcana":
                    Arcana(character, result);
                    break;
                case "Death":
                    Death(character, result);
                    break;
                case "Forge":
                    Forge(character, result);
                    break;
                case "Grave":
                    Grave(character, result);
                    break;
                case "Knowledge":
                    Knowledge(character, result);
                    break;
                case "Life":
                    Life(character, result);
                    break;
                case "Light":
                    Light(character, result);
                    break;
                case "Nature":
                    Nature(character, result);
                    break;
                case "Order":
                    Order(character, result);
                    break;
                case "Peace":
                    Peace(character, result);
                    break;
                case "Solidarity":
                    Solidarity(character, result);
                    break;
                case "Strength":
                    Strength(character, result);
                    break;
                case "Tempest":
                    Tempest(character, result);
                    break;
                case "Trickery":
                    Trickery(character, result);
                    break;
                case "Twilight":
                    Twilight(character, result);
                    break;
                case "War":
                    War(character, result);
                    break;
                case "Water":
                    Water(character, result);
                    break;
                case "Zeal":
                    Zeal(character, result);
                    break;
            }
            if (lvl >= 2)
            {
        ...
        public static void Ambition(Character character, CharacterClass result)
        {
        ...
        public static void Arcana(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Death(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Forge(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Grave(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            DomainSpells[1].Add("Bane*");
            DomainSpells[1].Add("False Life*");
        ...
        public static void Knowledge(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            ...
            string firstSkill = CLIHelper.GetNew(skills, character.SkillProficiencies, msg, errorMsg);
            character.SkillProficiencies.Add(firstSkill);
            msg = "Pick the 2nd skill now";
            string secondSkill = CLIHelper.GetNew(skills, character.SkillProficiencies, msg, errorMsg);
        ...
        public static void Life(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Light(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Nature(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Order(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            DomainSpells[1].Add("Command*");
        ...
        public static void Peace(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            DomainSpells[1].Add("Heroism*");
        ...
        public static void Solidarity(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            DomainSpells[1].Add("Bless*");
        ...
        public static void Strength(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Tempest(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            ...
            result.ClassFeatures.Add("Wrath of the Storm", "Wis/LR, reaction, when you are hit, Dex save, deal 2D8 Lightning or Thunder dmg");
            if (lvl >= 2)
            {
        ...
        public static void Trickery(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
        ...
        public static void Twilight(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            DomainSpells[1].Add("Faerie Fire*");
        ...
        public static void War(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            DomainSpells[1].Add("Divine Favor*");
            DomainSpells[1].Add("Shield of Faith*");
        ...
        public static void Water(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            DomainSpells[1].Add("Fog Cloud*");
        ...
        public static void Zeal(Character character, CharacterClass result)
        {
            int lvl = character.Lvl;
            DomainSpells[1].Add("Searing Smite*");
