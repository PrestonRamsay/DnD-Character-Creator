...
namespace DnD_Character_Creator.CharacterPieces.ClassSpecifics
{
    public static class BarbarianSpecifics
    {
        ...
        public static CharacterClass Features(Character character, CharacterClass result)
        {
            ...
            if (lvl >= 3)
            {
                ...
                switch (PathName)
                {
                    case "Ancestral Guardian":
                        AncestralGuardian(character, result);
                        break;
                    case "Battlerager":
                        Battlerager(character, result);
                        break;
                    case "Beast":
                        Beast(character, result);
                        break;
                    case "Berserker":
                        Berserker(character, result);
                        break;
                    case "Storm Herald":
                        StormHerald(character, result);
                        break;
                    case "Totem Warrior":
                        TotemWarrior(character, result);
                        break;
                    case "Wild Magic":
                        WildMagic(character, result);
                        break;
                    case "Zealot":
                        Zealot(character, result);
                        break;
                }
            }
            if (lvl >= 5)
            ...
            if (lvl >= 18)
            {
                result.ClassFeatures.Add("Indomitable Might", "If total Str check < Str score, use Str score for check instead");
            }
            if (lvl >= 20)
            {
        ...
        public static void AncestralGuardian(Character character, CharacterClass result)
        {
            int lvl = result.Lvl;
            int spiritDice = 2;
        ...
        public static void Battlerager(Character character, CharacterClass result)
        {
            int lvl = result.Lvl;
        ...
        public static void Beast(Character character, CharacterClass result)
        {
            int lvl = result.Lvl;
        ...
        public static void Berserker(Character character, CharacterClass result)
        {
            int lvl = result.Lvl;
        ...
        public static void StormHerald(Character character, CharacterClass result)
        {
            int lvl = result.Lvl;
            int fireAndIceDmg = 2;
            for (int i = 1; i <= lvl; i++)
        ...
        public static void TotemWarrior(Character character, CharacterClass result)
        {
            int lvl = result.Lvl;
        ...
        public static void Zealot(Character character, CharacterClass result)
        {
            int lvl = result.Lvl;
