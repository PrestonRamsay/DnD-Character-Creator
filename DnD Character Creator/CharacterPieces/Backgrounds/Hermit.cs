...
namespace DnD_Character_Creator.CharacterPieces.Backgrounds
{
    public class Hermit : Background
    {
        ...
        public static void AddStatics(Character character)
        {
            ...
            int seclusionIndex = Prompts.BackgroundPrompts("nature of your seclusion", hermit.LifeOfSeclusion);
            character.LifeOfSeclusion = hermit.LifeOfSeclusion[seclusionIndex];
        }
